...
<head>
    ...
    <meta name="description" content="P3M PENS - Pusat Penelitian dan Pengabdian kepada Masyarakat PENS">
    <meta name="author" content="yufieko">
    ...
    <link href="<?=base_url();?>public/frontend/css/bootstrap-theme.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <p class="copyright">Copyright &copy; 2014 - <a href="http://bootstraptaste.com">Bootstraptaste.com</a>
                    </p>
                </div>
            </div>
        </div>
